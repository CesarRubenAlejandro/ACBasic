...
public class ManejadorMemoria {
	...
	public static void separaMemoriaArreglo(int tipoArreglo, int sizeArreglo, int dirBase){
		if(isGlobal(dirBase)) {
			switch (tipoArreglo) {
			case Codigos.INT:
				contadorGlobalInt+= sizeArreglo;	
			case Codigos.FLOAT:
				contadorGlobalFloat+= sizeArreglo;			
			case Codigos.CHAR:
				contadorGlobalChar+= sizeArreglo;			
			case Codigos.STRING:
				contadorGlobalString+= sizeArreglo;
			case Codigos.BOOL:
				contadorGlobalBool+= sizeArreglo;
			}
		} else {
			switch (tipoArreglo) {
			case Codigos.INT:
				contadorInt+= sizeArreglo;	
			case Codigos.FLOAT:
				contadorFloat+= sizeArreglo;			
			case Codigos.CHAR:
				contadorChar+= sizeArreglo;			
			case Codigos.STRING:
				contadorString+= sizeArreglo;
			case Codigos.BOOL:
				contadorBool+= sizeArreglo;
			}
		}
